...
public class DataSeeder
{
    ...
    public async Task SeedAsync()
    {
        try
        {
            ...
            // Add EntryLines table if missing (EnsureCreated doesn't update existing DBs)
            await _context.Database.ExecuteSqlRawAsync(@"
                CREATE TABLE IF NOT EXISTS ""EntryLines"" (
                    ...
                    ""InDirection"" character varying(50) NOT NULL DEFAULT '',
                    ""IsActive"" boolean NOT NULL DEFAULT true,
                    ""CreatedAt"" timestamp with time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
                    ""UpdatedAt"" timestamp with time zone
                );
                CREATE INDEX IF NOT EXISTS ""IX_EntryLines_StoreId_IsActive"" ON ""EntryLines"" (""StoreId"", ""IsActive"");
            ");
